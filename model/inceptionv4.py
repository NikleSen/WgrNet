...
class InceptionV4(nn.Module):
    ...
    def __init__(self, A, B, C, k=192, l=224, m=256, n=384, class_num=100):
        ...
        self.linear = nn.Linear(1536, class_num)
...
def inceptionv4(class_num):
    return InceptionV4(4, 7, 3,class_num=class_num)
