...
class ResnetInResneet(nn.Module):
    def __init__(self, class_num=100):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(384, class_num, kernel_size=3, stride=2), #without this convolution, loss will soon be nan
...
def resnet_in_resnet(class_num):
    return ResnetInResneet(class_num=class_num)
