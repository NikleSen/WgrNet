...
def preactresnet18(class_num):
    return PreActResNet(PreActBasic, [2, 2, 2, 2],class_num=class_num)

def preactresnet34(class_num):
    return PreActResNet(PreActBasic, [3, 4, 6, 3],class_num=class_num)

def preactresnet50(class_num):
    return PreActResNet(PreActBottleNeck, [3, 4, 6, 3],class_num=class_num)

def preactresnet101(class_num):
    return PreActResNet(PreActBottleNeck, [3, 4, 23, 3],class_num=class_num)

def preactresnet152(class_num):
    return PreActResNet(PreActBottleNeck, [3, 8, 36, 3],class_num=class_num)
