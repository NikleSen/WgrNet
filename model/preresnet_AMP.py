...
class PreActResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, class_num, dropout):
...
def preactresnet18(class_num=10, dropout=0):
    return PreActResNet(PreActBlock, [2,2,2,2], class_num, dropout)


def preactresnet34(class_num=10, dropout=0):
    return PreActResNet(PreActBlock, [3,4,6,3], class_num, dropout)


def preactresnet50(class_num=10, dropout=0):
    return PreActResNet(PreActBottleneck, [3,4,6,3], class_num, dropout)


def preactresnet101(class_num=10, dropout=0):
    return PreActResNet(PreActBottleneck, [3,4,23,3], class_num, dropout)


def preactresnet152(class_num=10, dropout=0):
    return PreActResNet(PreActBottleneck, [3,8,36,3], class_num, dropout)
