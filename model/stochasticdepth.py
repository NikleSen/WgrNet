...
def stochastic_depth_resnet18(class_num):
    """ return a ResNet 18 object
    """
    return StochasticDepthResNet(StochasticDepthBasicBlock, [2, 2, 2, 2],class_num=class_num)

def stochastic_depth_resnet34(class_num):
    """ return a ResNet 34 object
    """
    return StochasticDepthResNet(StochasticDepthBasicBlock, [3, 4, 6, 3],class_num=class_num)

def stochastic_depth_resnet50(class_num):

    """ return a ResNet 50 object
    """
    return StochasticDepthResNet(StochasticDepthBottleNeck, [3, 4, 6, 3],class_num=class_num)

def stochastic_depth_resnet101(class_num):
    """ return a ResNet 101 object
    """
    return StochasticDepthResNet(StochasticDepthBottleNeck, [3, 4, 23, 3],class_num=class_num)

def stochastic_depth_resnet152(class_num):
    """ return a ResNet 152 object
    """
    return StochasticDepthResNet(StochasticDepthBottleNeck, [3, 8, 36, 3],class_num=class_num)
